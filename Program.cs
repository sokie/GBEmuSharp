...
namespace GBEmuSharp
{
    class Program
    {
        ...
        //some test data 
        static byte[] gb_classic_rom = new byte[]{
...
--------------------------- 0000 --
*/
        static Memory rom = new Memory(0x8000, 0); //Initialised with classic GB ROM
